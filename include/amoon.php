...
$query = "SELECT * FROM `all_coins` WHERE `coin_name` LIKE 'amoon' ORDER BY `all_coins`.`datetime` DESC LIMIT 1440";
...
<canvas id="amoon_Chart" style="width: 600px;max-width: 600px;display: block;height: 300px;margin: 0 auto;"></canvas>

<script>
var php_dates = '<?php echo $dates; ?>';
